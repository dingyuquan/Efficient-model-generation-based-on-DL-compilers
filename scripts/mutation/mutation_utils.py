...
class LayerUtils:
    ...
    def is_layer_in_weight_change_white_list(self, layer):
        ...
        white_list = [
            ...
            # origin
            keras.layers.Dense, keras.layers.Conv1D, keras.layers.Conv2D, keras.layers.Conv3D,
            ...
            keras.layers.Add, keras.layers.Subtract, keras.layers.Multiply, keras.layers.Average, keras.layers.Maximum,
            keras.layers.Concatenate,
            keras.layers.GlobalMaxPooling1D, keras.layers.GlobalMaxPooling2D, keras.layers.GlobalAveragePooling1D,
            keras.layers.GlobalAveragePooling2D,
            keras.layers.Dropout,
            keras.layers.Flatten,
            keras.layers.ZeroPadding1D, keras.layers.ZeroPadding2D, keras.layers.ZeroPadding3D,
            keras.layers.LSTM

            # 待测的
            # keras.layers.PReLU,
            # keras.layers.Cropping1D,keras.layers.Cropping2D,keras.layers.Cropping3D,
            # keras.layers.UpSampling1D,keras.layers.UpSampling2D,keras.layers.UpSampling3D,
            # keras.layers.Dot,
            # keras.layers.GaussianNoise,keras.layers.GaussianDropout,keras.layers.AlphaDropout,
